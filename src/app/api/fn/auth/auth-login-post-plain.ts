...
export function authLoginPost$Plain(http: HttpClient, rootUrl: string, params?: AuthLoginPost$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<AuthModel>> {
